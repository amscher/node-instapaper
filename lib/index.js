...
var Highlights = function Highlights(client) {
  this.client = client;
};

Highlights.prototype.list = function(id, params, callback) {
  return this.client.request(`/bookmarks/${id}/highlights`, params, callback);
};

Highlights.prototype.add = function(id, params, callback) {
  return this.client.request(`/bookmarks/${id}/highlight`, params, callback);
};

Highlights.prototype.delete = function(id, params, callback) {
  return this.client.request(`/highlights/${id}/delete`, params, callback);
};
